describe("User login", () => {
  it("successful login with valid credentials", () => {
    ...
    cy.get("input#email")
      ...
      .type("111202214138@mhs.dinus.ac.id")
      .should("have.value", "111202214138@mhs.dinus.ac.id");
  ...
  it("error display for missing @ in student email", () => {
    ...
    cy.get("input#email")
      .should("be.visible")
      .should("have.attr", "placeholder", "hello@example.com")
      .type("111202214138mhs.dinus.ac.id")
      .should("have.value", "111202214138mhs.dinus.ac.id");
  ...
  it("error display for missing domain in student email", () => {
    ...
    cy.get("input#email")
      ...
      .should("have.attr", "placeholder", "hello@example.com")
      .type("111202214138@")
      .should("have.value", "111202214138@");
  ...
  it("error display for missing dot in student email", () => {
    ...
    cy.get("input#email")
      .should("be.visible")
      .should("have.attr", "placeholder", "hello@example.com")
      .type("111202214138@mhsdinusacid")
      .should("have.value", "111202214138@mhsdinusacid");
