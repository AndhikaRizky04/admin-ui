...
Card.propTypes = {
  ...
  desc: PropTypes.node.isRequired, // `desc` wajib diisi dan bisa berupa node (teks, elemen, dll.)
  variant: PropTypes.string, // Bisa berupa string
};

// Menambahkan defaultProps untuk props opsional
Card.defaultProps = {
  title: false,
  variant: '',
};
